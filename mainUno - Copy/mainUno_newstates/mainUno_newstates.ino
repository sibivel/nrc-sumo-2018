...
void move_normal(uint16_t right_value, uint16_t left_value) {
    ...
    if (right_small) {
        ...
        if (left_small) {
            ...
            rightMotor((int) ((right_value - SMALL_THRESHOLD) * RATIO_SPEED / (LARGE_THRESHOLD - SMALL_THRESHOLD)));
            leftMotor((int) ((left_value - SMALL_THRESHOLD) * RATIO_SPEED / (LARGE_THRESHOLD - SMALL_THRESHOLD)));
